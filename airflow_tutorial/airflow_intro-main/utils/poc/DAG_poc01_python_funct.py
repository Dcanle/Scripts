...
default_args = {
    ...
    'start_date': datetime.datetime(2025, 4, 19),
    'email': email,
...
with DAG(nameDAG,
         ...
         max_active_runs = 3,
         schedule_interval = "0 22 * * 1-7") as dag: # schedule_interval = None # Caso sin trigger automático | schedule_interval = "0 12 * * *" | "0,2 12 * * *"
